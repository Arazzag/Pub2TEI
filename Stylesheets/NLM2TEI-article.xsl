            ...
            <teiHeader>
                <fileDesc>
                    ...
                    <publicationStmt>
                        ...
                        <xsl:if test="normalize-space(front/article-meta/permissions/copyright-statement[1]) or normalize-space(//front//permissions/license) or normalize-space(front/article-meta/permissions/copyright-holder) or pubfm/cpg/cpn">
                            <availability>
